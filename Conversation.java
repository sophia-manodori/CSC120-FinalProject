...
public class Conversation {
    ...
    public static void main(String[] args) {
        ...
        Plant shitake = new Plant("Shitake", "A patch of brown mushrooms growing from the base of a tree.", false, false);
        Plant ivy = new Plant("Poison Ivy", "A spiraling plant with three shiny leaves at every arm", true, true);
        Plant moss = new Plant("Moss", "Short little patches of soft green fronds, damp with dew", false, true);
