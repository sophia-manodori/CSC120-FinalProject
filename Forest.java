...
public class Forest extends Location{
    ...
    public Forest(String description) {
        ...
        Plant fig = new Plant("fig", "Fig: Some of the figs have dropped from the tree. they are rich in calcium and can help to restore a shell", false, false, true);
        Plant hemlock = new Plant("hemlock", "Hemlock: a small tree with little white flowers growing near by", true, true, false);
        this.addPlant(fig);
